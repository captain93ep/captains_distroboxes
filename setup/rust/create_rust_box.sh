...
# create the rust box
distrobox create rust --name rust --hostname rust --nvidia --image fedora:41 --home ${REPO_DIR}/homedirs/rust_home --additional-flags "--env GTK_THEME=Adwaita:dark"
...
cp -r ~/.ssh ${REPO_DIR}/homedirs/rust_home/.ssh
